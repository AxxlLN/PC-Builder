...
- [Регистрация:](https://github.com/AxxlLN/PC-Builder/blob/main/docs/sequence/Sign%20Up.png) - Диаграмма последовательности, описывающая процесс регистрации нового пользователя в системе. Показывает шаги, которые пользователь проходит для создания учётной записи, и взаимодействие с системой для успешной регистрации.
...
- [Заход в приложения:](https://github.com/AxxlLN/PC-Builder/blob/main/docs/sequence/First%20Start.png) - Диаграмма, показывающая какие действия может выполнять пользователь после захода в приложение.
